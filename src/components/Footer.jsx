      ...
      <footer className="flex justify-center bg-gray-50">
        <div className="w-full max-w-7xl flex flex-col items-center px-6 pt-20 lg:px-10 xl:px-24">
          ...
          <div className="w-full mt-10 py-10 border-t border-zinc-200 font-inter text-center text-xs text-zinc-400">
            Copyright © {new Date().getFullYear()} Birmatek Co. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
